...
![ACCumulative Status Fact](assets/accf_statusfact.png)

### ACCumulative Status Fact Orders Fact
![ACCumulative Status Fact Orders Fact](assets/accf_statusfact_ordersfact.png)

### Increment Load Snippets
![Increment Load Snippet 1](assets/increment_load_snippet1.png)
![Increment Load Snippet 2](assets/increment_load_snippet2.png)
